...
<div class="select-wrap">
    ...
    <div class="date-wrap clearfix">
        <ul>
            ...
            <?php } else { ?>
            <a href="<?php echo APP_PATH;?>lqsaicheng/?date=<?php echo $r['date'];?>">
...
<div class="data-wrap clearfix">
    <div class="event">
        ...
        <?php $n=1;if(is_array($future_schedule)) foreach($future_schedule AS $r) { ?>
            ...
            <div class="table-wrap" style="border: 1px solid #f2f2f2;">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td><?php echo $r['homeone'];?></td>
                        <?php if($r['sclasspart'] == 4) { ?><td><?php echo $r['hometwo'];?></td><?php } ?>
                        <td><?php echo $r['homethree'];?></td>
                        <?php if($r['sclasspart'] == 4) { ?><td><?php echo $r['homefour'];?></td><?php } ?>
                        <td class="grey2"><?php echo $r['homeFirstHalf'];?>/<?php echo $r['homeSecondHalf'];?></td>
                        <td><span class="red"><?php echo $r['homescore'];?></span></td>
                        <td class="grey2">半:<?php echo $r['halfDiff'];?></td>
                        <td class="grey2">半:<?php echo $r['halfSum'];?></td>
                        <td><span><?php echo $r['homewin_f'];?></span></td>
                        <td><span class="orange"><?php echo $r['letgoal_f'];?></span> <span class="pos"><?php echo $r['homeodds_f'];?></span></td>
                        <td><span class="orange fl ml18">小<?php echo $r['totalscore_f'];?></span> <?php echo $r['lowodds'];?></td>
                        <td rowspan="2">
                    ...
                    <tr>
                        ...
                        <td><span><?php echo $r['guestwin_f'];?></span></td>
                        <td><span class="orange"><span style="color: #FFF;"><?php echo $r['letgoal_f'];?></span></span> <span class="pos"><?php echo $r['guestodds_f'];?></span></td>
                        <td><span class="orange fl ml18">大<?php echo $r['totalscore_f'];?></span>&nbsp;<?php echo $r['highodds_f'];?></td>
                    </tr>
                </table>
            </div>
        </div>
...
<?php $js = array('bt_end_future.js', 'imagesloaded.pkgd.min.js', 'imagesloaded.pkgd.common.js');?>
