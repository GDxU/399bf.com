        ...
        <div class="row">
            <div class="bt-nav ft-end">
                <div class="inline-alink">
                    ...
                    <a href="<?php echo APP_PATH;?>zqsaicheng/" class="btn btn-alink active">下日</a>
                </div>
            ...
            <div class="date-nav" id="date-choose">
                <ul class="clearfix">
                    ...
                    <li <?php if($r[date] == $date) { ?>class="active"<?php } ?> data-url="<?php echo APP_PATH;?>zqsaicheng/?date=<?php echo $r['date'];?>">
