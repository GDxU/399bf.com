...
<div class="banner-wrap">
    <div class="shop">
        ...
        <div class="nav">
            <ul class="odds-nav">
                <li class="active"><a href="<?php echo APP_PATH;?>zqodds/">综合指数</a></li>
                <li><a href="<?php echo APP_PATH;?>zqoddseuro/">欧赔指数</a></li>
                <li><a href="<?php echo APP_PATH;?>zqoddsasia/">亚盘指数</a></li>
                <li><a href="<?php echo APP_PATH;?>zqoddsou/">大小球</a></li>
            </ul>
        </div>
    </div>
</div>
<div class="choose">
    <div class="choose-time clearfix">
        <ul style="float: left;">
            <li class="<?php if($odds_status == 1) { ?>active<?php } ?>"><a href="<?php echo APP_PATH;?>zqodds/">即时指数</a></li>
            <li class="<?php if($odds_status == 2) { ?>active<?php } ?>"><a href="<?php echo APP_PATH;?>zqodds/?odds_status=2">已开赛</a></li>
            <li class="<?php if($odds_status == 3) { ?>active<?php } ?>"><a href="<?php echo APP_PATH;?>zqodds/?odds_status=3">历史</a></li>
            <li class="<?php if($odds_status == 4) { ?>active<?php } ?>"><a href="<?php echo APP_PATH;?>zqodds/?odds_status=4">早盘</a></li>
            <li>
        ...
        <div id="date-wrap" class="search-date" >
            <form method="post" action="<?php echo APP_PATH;?>zqodds/">
...
<div class="content">
    ...
    <div class="data-container" data-competition="<?php echo $game['competitionid'];?>">
        <div class="competition-info">
            ...
            <span class="mrr40"><a target="_blank" href="<?php echo APP_PATH;?>team/<?php echo $game['awayteamid'];?>/"><?php echo $game['awayshortname'];?></a><span class="red ml5"><?php if(!empty($game[awayrank])) { ?>［<?php echo $game['awayrank'];?>］<?php } ?></span></span>
            <a target="_blank" href="<?php echo APP_PATH;?>game/<?php echo $gameid;?>/analyse/" class="analysis">析</a>
        </div>
        <div class="competition-data">
            <table>
                ...
                <tr>
                    ...
                    <td width="90"><?php if(isset($r[up])) { ?><?php echo $r['up'];?><?php } ?></td>
                    <td width="90"><?php if(isset($r[give])) { ?><?php echo get_handicap($r[give]);?><?php } ?></td>
                    <td width="90"><?php if(isset($r[down])) { ?><?php echo $r['down'];?><?php } ?></td>
                    <td width="90"><?php if(isset($r[homewin])) { ?><?php echo $r['homewin'];?><?php } ?></td>
                    <td width="90"><?php if(isset($r[draw])) { ?><?php echo $r['draw'];?><?php } ?></td>
                    <td width="90"><?php if(isset($r[awaywin])) { ?><?php echo $r['awaywin'];?><?php } ?></td>
                    <td width="90"><?php if(isset($r[big])) { ?><?php echo rtrim0($r[big]);?><?php } ?></td>
                    <td width="90"><?php if(isset($r[total])) { ?><?php echo handicap_ou($r[total]);?><?php } ?></td>
                    <td width="90"><?php if(isset($r[small])) { ?><?php echo rtrim0($r[small]);?><?php } ?></td>
                    <?php if($rowspan) { ?>
...
<div class="fixed-sidebar" id="fixedSidebar">
    ...
    <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=41dfde95fe38ccdec4011cfba6836270&action=lists_model&num=10&modelid=1&where=%60catid%60+IN+%2818%2C22%29\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists_model')) {$data = $content_tag->lists_model(array('modelid'=>'1','where'=>'`catid` IN (18,22)','limit'=>'10',));}?>
    ...
    <div class="sidebar-footer">
        <a href="<?php echo APP_PATH;?>zcfx/" target="_blank" class="fr more-link">更多》</a>
    </div>
