    ...
    <div class="shop">
        ...
        <div class="nav">
            <ul class="odds-nav">
                ...
                <li class="active"><a href="<?php echo APP_PATH;?>zqoddseuro/">欧赔指数</a></li>
...
<div class="choose">
    <div class="choose-time clearfix">
        <ul style="float: left;">
            <li class="<?php if($odds_status == 1) { ?>active<?php } ?>"><a href="<?php echo APP_PATH;?>zqoddseuro/">即时指数</a></li>
            <li class="<?php if($odds_status == 2) { ?>active<?php } ?>"><a href="<?php echo APP_PATH;?>zqoddseuro/?odds_status=2">已开赛</a></li>
            <li class="<?php if($odds_status == 3) { ?>active<?php } ?>"><a href="<?php echo APP_PATH;?>zqoddseuro/?odds_status=3">历史</a></li>
            <li class="<?php if($odds_status == 4) { ?>active<?php } ?>"><a href="<?php echo APP_PATH;?>zqoddseuro/?odds_status=4">早盘</a></li>
            <li>
        ...
        <div id="date-wrap" class="search-date" >
            <form method="post" action="<?php echo APP_PATH;?>zqoddseuro/">
...
<div class="content">
    ...
    <div class="data-container" data-competition="<?php echo $game['competitionid'];?>">
        <div class="competition-info">
            ...
            <a target="_blank" href="<?php echo APP_PATH;?>game/<?php echo $gameid;?>/analyse/" class="analysis" style="margin-right: 50px;">析</a>
        </div>
        <div class="competition-data">
            <table>
                ...
                <tr>
                    <td width="13.2%"><?php echo $r['companyname'];?></td>
                    <td width="10.8%"><?php if(isset($r[homewin])) { ?><?php echo $r['homewin'];?><?php } ?></td>
                    <td width="10.8%"><?php if(isset($r[draw])) { ?><?php echo $r['draw'];?><?php } ?></td>
                    <td width="10.8%"><?php if(isset($r[awaywin])) { ?><?php echo $r['awaywin'];?><?php } ?></td>
                    <td width="10.8%"><?php if(isset($r[returnrate])) { ?><?php echo $r['returnrate'];?><?php } ?></td>
                    <td width="10.8%"><?php if(isset($r[fhomewin])) { ?><?php echo $r['fhomewin'];?><?php } ?></td>
                    <td width="10.8%"><?php if(isset($r[fdraw])) { ?><?php echo $r['fdraw'];?><?php } ?></td>
                    <td width="10.8%"><?php if(isset($r[fawaywin])) { ?><?php echo $r['fawaywin'];?><?php } ?></td>
                    <?php if($rowspan) { ?>
                    <td width="11.3%" rowspan="<?php echo count($game[odds]);?>">
...
<div class="fixed-sidebar" id="fixedSidebar">
    ...
    <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=31383b9f6b1776a57d8ed83bf7564b04&action=lists_model&num=10&modelid=1&where=%60catid%60%3D20\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists_model')) {$data = $content_tag->lists_model(array('modelid'=>'1','where'=>'`catid`=20','limit'=>'10',));}?>
    ...
    <div class="sidebar-footer">
        <a href="<?php echo APP_PATH;?>ypfxf/" target="_blank" class="fr more-link">更多》</a>
    </div>
