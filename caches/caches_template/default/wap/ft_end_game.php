...
<html>
  ...
  <body>
    <div class="page-group">
        ...
        <div class="page page-current" id="ft_end">
            ...
            <header class="bar bar-nav">
                ...
                <nav class="header-nav">
                    <div class="buttons-row">
                        <a href="<?php echo WAP_PATH;?>zqwanchang/" class="button active">完场</a>
            ...
            <div class="content">
                ...
                <div class="buttons-tab">
                    ...
                    <a class="button <?php if($data['date'] == $date) { ?>active<?php } ?>" href="<?php echo WAP_PATH;?>zqwanchang/?date=<?php echo $data['date'];?>">
                ...
                <div class="card-box">
                    ...
                    <div class="card" data-action="link" data-url="<?php echo WAP_PATH;?>game/<?php echo $data['gameid'];?>/analyse/">
                        <!--<div class="row card-hd">-->
                            <!--<div class="col-20 card-title"><?php echo $data['competitionshortname'];?></div>-->
                            <!--<div class="col-20">-->
